  ...
  <main id="main" class="main">
    ...
    <div class="card">
      <div class="card-body">
          ...
          <!-- No Labels Form -->
          <form method="POST" action="{{ route('data.update',$row->id) }}" 
            enctype="multipart/form-data">
          @csrf
          @method('PUT') 
            <div class="col-md-12">
              <label for="basic-url" class="form-label">Nama Rumah Sakit</label>
              <input type="text" class="form-control" name="nama_rs" value="{{ $row->nama_rs }}" placeholder="Nama Rumah Sakit">
            </div>
            <div class="col-md-12">
              <label for="basic-url" class="form-label">Latitude</label>
              <input type="text" class="form-control" name="latitude" value="{{ $row->latitude }}" placeholder="Nama Rumah Sakit">
            </div>
            <div class="col-md-12">
              <label for="basic-url" class="form-label">Longtitude</label>
              <input type="text" class="form-control" name="longtitude" value="{{ $row->longtitude }}" placeholder="Nama Rumah Sakit">
            </div>         
